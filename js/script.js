...
$(function(){
  $("#signup").click(function(){
    $("#image_overlay_signup").fadeIn();
    $("#image_frame_signup").fadeIn();
  });

  $("#cut_signup").click(function(){
    $("#image_overlay_signup").fadeOut();
    $("#image_frame_signup").fadeOut();
  });
});

$("#mobile").click(function(){
  $("#link_hide_mobile").slideToggle('slow','linear');
});

$("#laptop").click(function(){
  $("#link_hide_laptop").slideToggle('slow','linear');
});

$("#ipads").click(function(){
  $("#link_hide_ipads").slideToggle('slow','linear');
});

$("#computer").click(function(){
  $("#link_hide_computer").slideToggle('slow','linear');
});

$("#tablet").click(function(){
  $("#link_hide_tablet").slideToggle('slow','linear');
});
